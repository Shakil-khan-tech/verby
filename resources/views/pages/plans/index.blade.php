        ...
        <div class="col-xl-4">
            <div class="card card-custom gutter-b card-stretch">
                <div class="card-body pb-0">
                    <div class="d-flex align-items-center">
                        <div class="d-flex flex-column mr-auto">
                            <h2 class="text-dark font-size-h2 font-weight-bold">
                                {{ $device->name }}
                                <i class="flaticon2-correct text-success icon-md ml-2"></i>
                            </h2>
                            <span class="text-muted">{{ __('ID') }}: {{ $device->id }}</span>
                        </div>
                    ...
                    <!-- Last Activity and Progress -->
                    <div class="d-flex mt-4">
                        <div class="mr-12">
                            <span class="d-block font-weight-bold mb-4">{{ __('Last involved') }}</span>
                            <span class="btn btn-light-primary btn-sm font-weight-bold">
                    ...
                    <div class="d-flex flex-wrap gap-2 mt-6">
                        <div class="flex-fill">
                            <span class="font-weight-bolder d-block">{{ __('Depa') }}</span>
                            <span class="font-size-h5">{{ $device->depa ?? '-' }} <small class="text-muted">min</small></span>
                        </div>
                        <div class="flex-fill">
                            <span class="font-weight-bolder d-block">{{ __('Restant') }}</span>
                            <span class="font-size-h5">{{ $device->restant ?? '-' }} <small class="text-muted">min</small></span>
                        </div>
                        <div class="flex-fill">
                            <span class="font-weight-bolder d-block">{{ __('Total Employees') }}</span>
                            <span class="label label-xl label-light-primary label-inline px-3 py-5">
                    ...
                    <div class="d-flex flex-wrap mt-6">
                        <div class="flex-fill">
                            <span class="font-weight-bolder d-block mb-2">{{ __('Managers') }}</span>
                        ...
                        <div class="flex-fill">
                            <span class="font-weight-bolder d-block mb-2">{{ __('Employees') }}</span>
                            <div class="symbol-group symbol-hover">
                ...
                <div class="card-footer py-5">
                    <a href="{{ route('plans.show', $device->id) }}" class="btn btn-block btn-sm btn-light-success font-weight-bolder text-uppercase">
                        {{ __('View Plan') }}
                    </a>
                </div>
            </div>
