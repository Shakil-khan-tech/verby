        ...
        <div class="col-xl-4">
          ...
          <div class="card card-custom gutter-b card-stretch">
            ...
            <div class="card-body pb-0">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="card-toolbar mb-auto">
                  <div class="dropdown dropdown-inline" data-toggle="tooltip" title="{{ __('Quick actions') }}" data-placement="left">
                          ...
                          <form method="POST" action="{{ route('devices.destroy', $device->id) }}">
                              ...
                              <div class="navi-link">
                                ...
                                <span class="navi-text text-danger">
                                  <input type="submit" class="bg-transparent" onclick="return confirm('{{ __('Deleting the device will delete all employees in it! Are you sure?') }}')" value="{{ __('Delete') }}">
                                </span>
                              </div>
                          </form>
                        </li>
              ...
              <div class="d-flex mt-4">
                <div class="mr-12 d-flex flex-column mb-7">
                  ...
                  <span class="btn btn-light-primary btn-sm font-weight-bold btn-upper btn-text">
                    {{ $last_activities->where('id', $device->id)->first()->updated_at ? $last_activities->where('id', $device->id)->first()->updated_at : __('no action') }}
                  </span>
                </div>
                <!--begin::Progress-->
                <div class="flex-row-fluid mb-7">
                  ...
                  <div class="d-flex align-items-center pt-2">
                    <div class="progress progress-xs mt-2 mb-2 w-100">
                      <div class="progress-bar bg-warning" role="progressbar" style="width: {{ round( $device->employees->count() / $total_employees * 100, 2 ) }}%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <span class="ml-3 font-weight-bolder">{{ round( $device->employees->count() / $total_employees * 100, 2 ) }}%</span>
                  </div>
                </div>
                <!--end::Progress-->
              </div>
              ...
              <div class="d-flex flex-wrap gap-2">
                ...
                <div class="d-flex flex-column flex-fill mb-7">
                  ...
                  <span class="font-weight-bolder font-size-h5 pt-1">{{ $device->depa }} <span class="font-weight-bold text-dark-50">{{ __('min') }}</span></span>
                </div>
                <!--end::Item-->
                <!--begin::Item-->
                <div class="d-flex flex-column flex-fill mb-7">
                  <span class="font-weight-bolder mb-4">{{ __('Restant') }}</span>
                  <span class="font-weight-bolder font-size-h5 pt-1">{{ $device->restant }} <span class="font-weight-bold text-dark-50">{{ __('min') }}</span></span>
                </div>
                <!--end::Item-->
                <!--begin::Item-->
                <div class="d-flex flex-column flex-fill mb-7">
                  <span class="font-weight-bolder mb-4">{{ __('Total Employees') }}</span>
                  <span class="font-weight-bolder label label-xl label-light-primary label-inline px-3 py-5 min-w-45px"> {{ $device->employees->count() }} </span>
                </div>
                <!--end::Item-->
              </div>
              <!--end::Blog-->
            ...
            <div class="card-footer d-flex align-items-center py-5">
              <a href="{{ route('monthly_reports.show', $device->id) }}" class="btn btn-block btn-sm btn-light-success font-weight-bolder text-uppercase py-4">{{ __('View Monthly Reports') }}</a>
            </div>
            <!--end::Footer-->
          </div>
          <!--end::Card-->
