        ...
        <div class="col-md-8">
          ...
          <div class="card card-custom gutter-b example example-compact">
            <div class="card-header">
              <h3 class="card-title">{{ __('Manage holidays') }}</h3>
            </div>
            <!--begin::Form-->
            <form class="form" action="{{ route('holidays.store') }}" method="post">
              @csrf
              <div class="card-body">
                <div id="holiday_repeater">

                  <div data-repeater-list="holidays" class="form-group row">
                    @forelse($holidays as $holiday)
                      <div data-repeater-item="" class="form-group row align-items-center col-lg-12">
                        <div class="col-md-6">
                          <label>{{ __('Name') }}:</label>
                          <input type="text" name="name" class="form-control" placeholder="{{ __('Enter vacation name') }}" value="{{ $holiday->name }}" required />
                          <div class="d-md-none mb-2"></div>
                        </div>
                        <div class="col-md-4">
                          <label>{{ __('Date') }}:</label>
                          <input type="text" name="month_day" class="form-control date_picker" placeholder="{{ __('Enter vacation date') }}" value="{{ $holiday->month_day }}" autocomplete="off" required />
                          <div class="d-md-none mb-2"></div>
                        </div>
                        <div class="col-md-2">
                    ...
                    @empty
                      <div data-repeater-item="" class="form-group row align-items-center col-lg-12">
                        ...
                        <div class="col-md-4">
                          <label>{{ __('Date') }}:</label>
                          <input type="text" name="month_day" class="form-control date_picker" placeholder="{{ __('Enter vacation date') }}" autocomplete="off" required />
                          <div class="d-md-none mb-2"></div>
                        </div>
                        <div class="col-md-2">
                          <label>{{ __('Action') }}:</label><br>
...
@section('scripts')
    ...
    {{-- page scripts --}}
    <script src="{{ mix('js/pages/holidays/index.js') }}" type="text/javascript"></script>
