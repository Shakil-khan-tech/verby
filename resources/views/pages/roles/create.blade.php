  ...
  <div class="d-flex flex-row">
    ...
    <div class="flex-row-fluid ml-lg-8">
      ...
      <div class="card card-custom card-stretch">
        ...
        <!--end::Header-->
        <!--begin::Form-->
        <form id="permissions_Role" action="{{ route('roles.store') }}" method="post" class="form">
          @csrf
          <!--begin::Body-->
          <div class="card-body">
            <div class="row justify-content-md-center">
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name"  placeholder="{{ __('Access Management Name') }}" required />
            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="form-group row align-items-center">
                  ...
                  <label class="col-3 col-lg-2 col-form-label font-weight-bold text-left text-right">{{ __('Edit') }}</label>
                  <div class="col-3 col-lg-3">
                    <span class="switch switch-sm">
                      <label>
                ...
                <div class="form-group row align-items-center">
                  ...
                  <div class="col-3 col-lg-3">
                    <span class="switch switch-sm">
                      <label>
                        <input type="checkbox" name="permissions[]" value="view_devices" data-model="device" data-action="view" checked="checked" />
                        <span></span>
                      </label>
                    </span>
                  </div>
                ...
                <div class="form-group row align-items-center">
                  ...
                  <div class="col-3 col-lg-3">
                    <span class="switch switch-sm">
                      <label>
                        <input type="checkbox" name="permissions[]" value="view_employees" data-model="employee" data-action="view" checked="checked" />
                        <span></span>
                      </label>
                    </span>
                  </div>
                  ...
                  <div class="col-3 col-lg-3">
                    <span class="switch switch-sm">
                      <label>
                        <input type="checkbox" name="permissions[]" value="manage_employees" data-model="employee" data-action="manage" checked="checked" />
                        <span></span>
                      </label>
                    </span>
                  </div>
                ...
                <div class="form-group row align-items-center">
                  ...
                  <div class="col-3 col-lg-3">
                    <span class="switch switch-sm">
                      <label>
                        <input type="checkbox" name="permissions[]" value="view_vacations" data-model="vacation" data-action="view" checked="checked" />
                        <span></span>
                      </label>
                    </span>
                  </div>
                ...
                <div class="form-group row align-items-center">
                  ...
                  <div class="col-3 col-lg-3">
                    <span class="switch switch-sm">
                      <label>
                        <input type="checkbox" name="permissions[]" value="view_records" checked="checked" data-model="record" data-action="view" />
                        <span></span>
                      </label>
                    </span>
                  </div>
                ...
                <div class="form-group row align-items-center">
                  <label class="col-3 col-lg-2 col-form-label font-weight-bold text-left text-right">{{ __('Manage') }}</label>
                  <div class="col-3 col-lg-3">
                    <span class="switch switch-sm">
                      <label>
                ...
                <div class="form-group row align-items-center">
                  ...
                  <div class="col-3 col-lg-3">
                    <span class="switch switch-sm">
                      <label>
                        <input type="checkbox" name="permissions[]" value="view_contracts" checked="checked" data-model="contract" data-action="view" />
                        <span></span>
                      </label>
                    </span>
                  </div>
                  ...
                  <div class="col-3 col-lg-3">
                    <span class="switch switch-sm">
                      <label>
                        <input type="checkbox" name="permissions[]" value="manage_contracts" data-model="contract" data-action="manage" />
                        <span></span>
                      </label>
                    </span>
                  </div>
              ...
              <div class="border-left-lg col-lg-6">
                ...
                <div class="form-group row align-items-center">
                  ...
                  <div class="col-3 col-lg-3">
                    <span class="switch switch-sm">
                      <label>
                        <input type="checkbox" name="permissions[]" value="view_holidays" data-model="holiday" data-action="view" checked="checked" />
                        <span></span>
                      </label>
                    </span>
                  </div>
                  ...
                  <div class="col-3 col-lg-3">
                    <span class="switch switch-sm">
                      <label>
                        <input type="checkbox" name="permissions[]" data-model="holiday" data-action="manage" value="manage_holidays" />
                        <span></span>
                      </label>
                    </span>
                  </div>
                ...
                <div class="form-group row align-items-center">
                  ...
                  <div class="col-3 col-lg-3">
                    <span class="switch switch-sm dependable" data-by="device">
                      <label>
                        <input type="checkbox" name="permissions[]" value="manage_plans" data-model="plan" data-action="manage" checked="checked" />
                        <span></span>
                      </label>
                    </span>
                  </div>
                ...
                <div class="form-group row align-items-center">
                  ...
                  <div class="col-3 col-lg-3">
                    <span class="switch switch-sm dependable" data-by="device">
                      <label>
                        <input type="checkbox" name="permissions[]" value="manage_calendars" data-model="calendar" data-action="manage" checked="checked" />
                        <span></span>
                      </label>
                    </span>
                  </div>
                ...
                <div class="form-group row align-items-center">
                  ...
                  <div class="col-3 col-lg-3">
                    <span class="switch switch-sm dependable" data-by="employee">
                      <label>
                        <input type="checkbox" name="permissions[]" value="manage_payrolls" data-model="payroll" data-action="manage" checked="checked" />
                        <span></span>
                      </label>
                    </span>
                  </div>
                ...
                <div class="form-group row align-items-center">
                  ...
                  <div class="col-3 col-lg-3">
                    <span class="switch switch-sm dependable" data-by="device, employee">
                      <label>
                        <input type="checkbox" name="permissions[]" value="manage_daily_reports" data-model="daily_reports" data-action="manage" checked="checked" />
                        <span></span>
                      </label>
                    </span>
                  </div>
