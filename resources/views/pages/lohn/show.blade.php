              ...
              <div class="d-table w-100 pb-10 pb-md-20">
                ...
                <div class="d-table-cell text-right px-0">
                  <span class="d-flex flex-column align-items-md-end opacity-70">
                    ...
                    <span>{{ __('Tel') }}: {{ $employee->phone }}</span>
                  </span>
                </div>
              </div>
              ...
              <div class="table-responsive">
                <table class="table">
                  ...
                  <tbody>
                    ...
                    @isset( $lohn )
                      @if( $lohn->B_KTG_1 != 0 && $lohn->B_KTG_2 != 0)
                        <tr class="">
                          <td class="pl-0 py-2">107</td>
                          <td class="pl-0 py-2">{{ __('KTG') }}</td>
                          <td class="text-right py-2">{{ $lohn->B_KTG_1 }}x</td>
                          <td class="text-right py-2">Fr. {{ $lohn->B_KTG_2 }}%</td>
                          <td class="text-right py-2">Fr.</td>
                          <td class="text-right py-2">{{ $KTG ?? '' }}</td>
                          <td class="text-danger pr-0 py-2 text-right"></td>
                        </tr>
                      @endif
                      @if( $lohn->B_unfall_1 != 0 && $lohn->B_unfall_2 != 0)
                        <tr class="">
                          <td class="pl-0 py-2">108</td>
                          <td class="pl-0 py-2">{{ __('UVG') }}</td>
                          <td class="text-right py-2">{{ $lohn->B_unfall_1 }}x</td>
                          <td class="text-right py-2">Fr. {{ $lohn->B_unfall_2 }}%</td>
                          <td class="text-right py-2">Fr.</td>
                    ...
                    @isset($lohn)
                      @if ($lohn->B_bonnus1_2 != 0)
                        <tr class="">
                          <td class="pl-0 py-2">110</td>
                          <td class="pl-0 py-2">{{ $lohn->B_bonnus1_1 }}</td>
                          <td class="text-right py-2"></td>
                          <td class="text-right py-2"></td>
                          <td class="text-right py-2">Fr.</td>
                      ...
                      @endif
                      @if ($lohn->B_bonnus2_2 != 0)
                        <tr class="">
                          <td class="pl-0 py-2">110</td>
                          <td class="pl-0 py-2">{{ $lohn->B_bonnus2_1 }}</td>
                          <td class="text-right py-2"></td>
                          <td class="text-right py-2"></td>
                          <td class="text-right py-2">Fr.</td>
                    ...
                    @isset( $lohn )
                      @if ( $lohn->A_Verplegung_1 != 0 && $lohn->A_Verplegung_2 != 0 )
                        <tr class="">
                          <td class="pl-0 py-2">207</td>
                          <td class="pl-0 py-2">{{ __('Meals') }} <span class="float-right">{{ $lohn->A_Verplegung_1 }} {{ __('Days') }}</span></td>
                          <td class="text-right py-2">Fr. {{ $lohn->A_Verplegung_2 }}</td>
                          <td class="text-right py-2">{{ __('out of') }}</td>
                      ...
                      @endif
                      @if ( $lohn->A_bonnus1_2 != 0 )
                        <tr class="">
                          <td class="pl-0 py-2">208</td>
                          <td class="pl-0 py-2">{{ $lohn->A_bonnus1_1 }}</td>
                          <td class="text-right py-2"></td>
                          <td class="text-right py-2"></td>
                          <td class="text-right py-2">Fr.</td>
                      ...
                      @endif
                      @if ( $lohn->A_bonnus2_2 != 0 )
                        <tr class="">
                          <td class="pl-0 py-2">209</td>
                          <td class="pl-0 py-2">{{ $lohn->A_bonnus2_1 }}</td>
                          <td class="text-right py-2"></td>
                          <td class="text-right py-2"></td>
                          <td class="text-right py-2">Fr.</td>
              ...
              <div class="table-responsive">
                <table class="table">
                  ...
                  <tbody>
                    ...
                    @if ( $employee->PartTime == 1 )
                      @if ( isset($lohn) && $lohn->KONTO_Ferie_PAY > 0 )
                        <tr class="">
                    ...
                    @if ( isset($lohn) && floatval($lohn->KONTO_13monats_PAY) > 0 )
                      <tr class="">
                    ...
                    @isset( $lohn )
                      @if ( $lohn->KONTO_Ferie_PAY > 0 || $lohn->KONTO_13monats_PAY > 0)
                        <tr class="font-weight-boldest">
                          ...
                          <td class="text-danger font-size-h3 font-weight-boldest text-right pr-0">
                            Fr. {{ $NettoLohn2 + floatval($lohn->KONTO_Ferie_PAY) + floatval($lohn->KONTO_13monats_PAY) }}
                          </td>
                        </tr>
                      @endif
                    @endisset
...
@section('scripts')
    ...
    {{-- page scripts --}}
    <script src="{{ mix('js/pages/lohn/show.js') }}" type="text/javascript"></script>
