        ...
        <div class="col-xl-4">
          ...
          <div class="card card-custom gutter-b card-stretch">
                        ...
                        <li class="navi-item">
                          <form method="POST" action="{{ route('devices.destroy', $device->id) }}">
                              ...
                              <div class="navi-link">
                                ...
                                <span class="navi-text text-danger"><input type="submit" class="bg-transparent" onclick="return confirm('{{ __('Deleting the device will delete all employees in it! Are you sure?') }}')" value="{{ __('Delete') }}"></span>
                              </div>
                          </form>
                        </li>
                      </ul>
            ...
            <div class="card-footer d-flex align-items-center py-5">
              <a href="{{ route('monthly_performance.show', $device->id) }}" class="btn btn-block btn-sm btn-light-success font-weight-bolder text-uppercase py-4">{{ __('View Monthly Performance Reports') }}</a>
            </div>
            <!--end::Footer-->
          </div>
          <!--end::Card-->
