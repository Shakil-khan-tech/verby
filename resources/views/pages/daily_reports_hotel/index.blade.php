        ...
        <div class="col-xl-4">
          ...
          <div class="card card-custom gutter-b card-stretch">
            ...
            <div class="card-footer d-flex align-items-center py-5">
              <a href="{{ route('daily_reports_hotel.show', $device->id) }}" class="btn btn-block btn-sm btn-light-success font-weight-bolder text-uppercase py-4">{{ __('View Daily Reports for Hotel') }}</a>
            </div>
            <!--end::Footer-->
          </div>
          <!--end::Card-->
