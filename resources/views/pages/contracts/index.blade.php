        ...
        <div class="card card-custom card-stretch col-12">
          ...
          <div class="card-header py-3">
            <div class="card-title align-items-start flex-column">
              <h3 class="card-label font-weight-bolder text-dark">{{ __('Contract') }}</h3>
              <span class="text-muted font-weight-bold font-size-sm mt-1">{{ __('Manage Employee Contract') }}</span>
            </div>
              ...
              <div class="col-12 col-lg-12">
                <div class="future-dropzone dropzone-default dropzone-success" id="kt_dropzone_files">
                  <div class="dropzone-msg dz-message needsclick">
                    ...
                    <span class="dropzone-msg-desc">{{ __('Only .docx documents are allowed for upload') }}.</span>
                  </div>
                </div>
              </div>
            </div>
...
@section('scripts')
    ...
    <script>
      ...
      var files_store_url = "{{ route('contracts.files.store') }}";
      var files_get_url = "{{ route('contracts.files.get') }}";
    </script>
    <script src="{{ mix('js/pages/contracts/contract.js') }}" type="text/javascript"></script>
