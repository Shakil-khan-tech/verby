        ...
        <div class="col-xl-4">
          ...
          <div class="card card-custom gutter-b card-stretch">
                  ...
                  <div class="dropdown dropdown-inline" data-toggle="tooltip" title="{{ __('Quick actions')}}" data-placement="left">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                      ...
                      <ul class="navi navi-hover">
                        ...
                        <li class="navi-item">
                          <a href="{{ route('devices.auth', $device->id) }}" class="navi-link">
                            <span class="navi-icon">
                              <i class="flaticon-lock"></i>
                            </span>
                            <span class="navi-text">{{ __('Authentication') }}</span>
                          </a>
                        </li>
                        <li class="navi-item">
                          <a href="{{ route('devices.report', $device->id) }}" class="navi-link">
                            <span class="navi-icon">
                              <i class="flaticon-clipboard"></i>
                            </span>
                            <span class="navi-text">{{ __('Report') }}</span>
                          </a>
                        </li>
                        <li class="navi-item">
                          <form method="POST" action="{{ route('devices.destroy', $device->id) }}">
                              ...
                              <div class="navi-link">
                                ...
                                <span class="navi-text text-danger"><input type="submit" class="bg-transparent" onclick="return confirm('{{ __('Deleting the device will delete all employees in it! Are you sure?') }}')" value="Delete"></span>
                              </div>
                          </form>
                        </li>
                      </ul>
            ...
            <div class="card-footer d-flex align-items-center py-5">
              <a href="{{ route('devices.show', $device->id) }}" class="btn btn-block btn-sm btn-light-success font-weight-bolder text-uppercase py-4">{{ __('View Device') }}</a>
            </div>
            <!--end::Footer-->
          </div>
          <!--end::Card-->
