...
<div id="kt_header_mobile" class="header-mobile {{ Metronic::printClasses('header-mobile', false) }}" {{ Metronic::printAttrs('header-mobile') }}>
    <div class="mobile-logo">
        <a href="{{ route('home') }}">
            ...
            <img alt="{{ config('app.name') }}" src="{{ asset('media/logos/'.$kt_logo_image) }}" class="h-30px" />
        </a>
    </div>
    <div class="d-flex align-items-center">
        ...
        <button class="btn btn-hover-text-primary p-0 ml-2 d-flex" id="kt_header_mobile_topbar_toggle">
            {{ Metronic::getSVG('media/svg/icons/General/User.svg', 'svg-icon-xxl') }}
        </button>
