...
<div class="topbar">
    ...
    @if (config('layout.extras.search.display'))
        @if (config('layout.extras.search.layout') == 'offcanvas')
            <div class="topbar-item">
                <div class="btn btn-icon btn-clean btn-sm mr-1" id="kt_quick_search_toggle">
    ...
    @if (config('layout.extras.notifications.display'))
        @if (config('layout.extras.notifications.layout') == 'offcanvas')
            <div class="topbar-item">
                <div class="btn btn-icon btn-clean btn-sm mr-1 pulse pulse-primary" id="kt_quick_notifications_toggle">
        ...
        @else
            <div class="dropdown">
                {{-- Toggle --}}
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-sm mr-1 pulse pulse-primary">
                        {{ Metronic::getSVG("media/svg/icons/Code/Compiling.svg", "svg-icon-xl svg-icon-primary") }}
                        <span class="pulse-ring"></span>
                    </div>
                </div>
    ...
    @if (config('layout.extras.quick-actions.display'))
        @if (config('layout.extras.quick-actions.layout') == 'offcanvas')
            <div class="topbar-item">
                <div class="btn btn-icon btn-clean btn-dropdown btn-sm mr-1" id="kt_quick_actions_toggle">
        ...
        @else
            <div class="dropdown">
                {{-- Toggle --}}
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-sm mr-1">
                        {{ Metronic::getSVG("media/svg/icons/Media/Equalizer.svg", "svg-icon-xl svg-icon-primary") }}
                    </div>
                </div>
    ...
    @if (config('layout.header.topbar.quick-panel.display'))
        <div class="topbar-item">
            <div class="btn btn-icon btn-clean btn-sm mr-1" id="kt_quick_panel_toggle">
    ...
    @if (config('layout.extras.languages.display'))
        <div class="dropdown">
            <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                <div class="btn btn-icon btn-clean btn-dropdown btn-sm mr-1">
                    <img class="h-20px w-20px rounded-sm" src="{{ asset('media/svg/flags/'. LaravelLocalization::getCurrentLocale() .'.svg') }}" alt="{{ LaravelLocalization::getCurrentLocaleName() }}"/>
                </div>
            </div>
    ...
    {{-- External Link --}}
    <div class="topbar-item">
        <a href="https://email.aaab.ch" target="_blank" class="btn btn-icon btn-clean btn-sm mr-1" title="Open email">
            {{ Metronic::getSVG("media/svg/icons/Communication/Mail-external.svg", "svg-icon-xl svg-icon-primary") }}
        </a>
    </div>
    ...
    @if (config('layout.extras.user.display'))
        @if (config('layout.extras.user.layout') == 'offcanvas')
            <div class="topbar-item">
                <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-sm px-2" id="kt_quick_user_toggle">
                    {{-- <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Hi,</span> --}}
                    {{-- <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ $authenticated_user->name }}</span> --}}
                    <span class="symbol symbol-30 symbol-light-success">
                        <span class="symbol-label font-size-h5 font-weight-bold">{{ substr( $authenticated_user->name, 0, 1 ) }}</span>
                    </span>
                </div>
            </div>
        @else
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
                    <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-sm px-2">
                        {{-- <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Hi,</span> --}}
                        {{-- <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ $authenticated_user->name }}</span> --}}
                        <span class="symbol symbol-30 symbol-light-success">
                            <span class="symbol-label font-size-h5 font-weight-bold">{{ substr( $authenticated_user->name, 0, 1 ) }}</span>
