...
@if (config('layout.extras.notifications.dropdown.style') == 'light')
    <div class="d-flex flex-column pt-12 bg-dark-o-5 rounded-top">
        ...
        <h4 class="d-flex flex-center">
            <span class="text-dark">{{ __('Notifications') }}</span>
        ...
        <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-primary mt-3 px-8" role="tablist">
            <li class="nav-item">
                <a class="nav-link active show" data-toggle="tab" href="#topbar_notifications_notifications"  >{{ __('Alerts') }}</a>
            </li>
            {{-- <li class="nav-item">
...
<div class="tab-content">
    ...
    <div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
        @if ($email_notifications->isNotEmpty())
            {{-- Scroll --}}
            <div class="scroll pr-7 mr-n7" data-scroll="true" data-height="150" data-mobile-height="150">
                    ...
                    <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="symbol symbol-40 symbol-light-primary mr-5">
                            <span class="symbol-label">
                                {{ Metronic::getSVG("media/svg/icons/Communication/Mail.svg", "svg-icon-lg svg-icon-primary") }}
                            </span>
                        </div>

                        {{-- Text --}}
                        <div class="d-flex flex-column font-weight-bold">
                            <a href="{{ route('emails.show', $notification['email']) }}" class="text-dark text-hover-primary mb-1 font-size-lg">High email usage</a>
                            <span class="text-muted">{{ $notification['email'] }} uses {{ $notification['used'] }}%</span>
                        </div>
                    </div>
                @endforeach
            </div>
