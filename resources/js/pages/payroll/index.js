...
var Payroll = function() {
  ...
  var _initDatatable = function() {
          ...
          columns: [{
              ...
              template: function(row) {
                  ...
                  var output = `<div class="d-flex align-items-center">
                    ...
                    <div class="ml-2">
                      <a href="/${Lang.locale}/lohn/${row.id}/${moment().format('YYYY-MM-DD')}">
              ...
              template: function(row) {
                  return `
                      <a href="/${Lang.locale}/lohn/${row.id}/${moment().format('YYYY-MM-DD')}" class="btn btn-icon btn-light btn-hover-primary btn-sm w-100">
      ...
      $('#employee_datatable_search_status, #employee_datatable_search_type').selectpicker();
  };
