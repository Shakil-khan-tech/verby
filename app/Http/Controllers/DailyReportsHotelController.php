...
class DailyReportsHotelController extends Controller
{
    use RecordTrait;
    ...
    public function index()
    {
        ...
        $page_title = __('Daily Reports for Hotel');
        ...
        return view('pages.daily_reports_hotel.index', compact('page_title', 'page_description', 'devices', 'total_employees', 'last_activities'));
    }
    ...
    public function show(Device $device, Request $request)
    {
        ...
        $page_title = __('Daily Reports - Hotel for ') . $from->format('d.m.Y');
        ...
        return view('pages.daily_reports_hotel.show', compact('page_title', 'page_description', 'device', 'day', 'employees_func', 'daily_employees', 'managers'));
    }
}
